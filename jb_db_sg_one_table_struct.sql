...
#	`cg_clzb_pay_amt` double DEFAULT NULL COMMENT '材料质保期满后付款金额',
	`cg_buy_man_1` char(10) DEFAULT NULL COMMENT '采购部项目负责人1',
	`cg_buy_man_1_work_rate` double DEFAULT NULL COMMENT '负责人1工作占比',
	`cg_buy_man_2` char(10) DEFAULT NULL COMMENT '采购部项目负责人2',
	`cg_buy_man_2_work_rate` double DEFAULT NULL COMMENT '负责人2工作占比',
	#'采购管理部';
