...
CREATE TABLE `jb_project` (
  ...
  `sh_zb_sub_detail` longtext COMMENT '质保子项-JSON格式: 包括: 项目明细名称, 项目质保子项明细内容,项目质保子项原因',
	...
	`sh_sh_myd_1_desc` varchar(500) DEFAULT NULL COMMENT '客户满意度:售后1 相关说明',
	`sh_sh_myd_2`      char(1) DEFAULT NULL COMMENT '客户满意度:售后2',
	`sh_sh_myd_2_desc` varchar(500) DEFAULT NULL COMMENT '客户满意度:售后2 相关说明',
  ...
  `sh_myd_sub_detail` longtext COMMENT '售后满意度调查表子项-JSON格式: 包括: 名称,售后满意度调查表子项原因,售后满意度附加信息',
	...
	#
	`cg_zxclcg_sm`    varchar(500) DEFAULT NULL COMMENT '装修材料采购:  相关说明',
	`cg_jdsbcg_sm`    varchar(500) DEFAULT NULL COMMENT '机电设备采购:  相关说明',
	`cg_gckc_sm`      varchar(500) DEFAULT NULL COMMENT '工厂库存及零星材料采购总金额:  相关说明',
	`cg_gcrgf_sm`     varchar(500) DEFAULT NULL COMMENT '工厂人工费:  相关说明',
	#
	`cg_rlzy_cgr1`    tinyint(4) DEFAULT NULL COMMENT '人力资源:采购员1',
	`cg_rlzy_cgr1_choose`  tinyint(4) DEFAULT NULL COMMENT '人力资源:采购员1 工作比例',
	`cg_rlzy_cgr1_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:采购员1  相关说明',	
	`cg_rlzy_cgr2`    tinyint(4) DEFAULT NULL COMMENT '人力资源:采购员2',
	`cg_rlzy_cgr2_choose`  tinyint(4) DEFAULT NULL COMMENT '人力资源:采购员2 工作比例',
	`cg_rlzy_cgr2_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:采购员2  相关说明',
	#
	#'采购管理部';
  ...
  `gc_rlzy_xmzj_choose`  tinyint(4) DEFAULT NULL COMMENT '人力资源:项目总监 工作比例',
	...
	`gc_rlzy_zxgz1_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:装修工长1  相关说明',
	...
	`gc_rlzy_zxgz2_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:装修工长2  相关说明',
	...
	`gc_rlzy_kfbj1_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:库房及保洁负责人1  相关说明',
	...
	`gc_rlzy_kfbj2_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:库房及保洁负责人2  相关说明',
	`gc_rlzy_gczl`    tinyint(4) DEFAULT NULL COMMENT '人力资源:工程助理',
	`gc_rlzy_gczl_choose`  tinyint(4) DEFAULT NULL COMMENT '人力资源:工程助理 工作比例',
	`gc_rlzy_gczl_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:工程助理  相关说明',
	#
	#'工程管理部';
	
	#机电管理部
	`jd_jdfatj_time` datetime DEFAULT NULL COMMENT '机电方案提交日期',
	`jd_jdfatj_time_desc` varchar(500) DEFAULT NULL COMMENT '机电方案提交日期相关说明',
	#
	`jd_jdbpttj_time` datetime DEFAULT NULL COMMENT '机电报批图提交日期',
	`jd_jdbpttj_time_desc` varchar(500)  DEFAULT NULL COMMENT '机电报批图提交日期:相关说明',
	#
	`jd_jdsgttj_time` datetime DEFAULT NULL COMMENT '机电施工图提交日期',
	`jd_jdsgttj_time_desc` varchar(500)  DEFAULT NULL COMMENT '机电施工图提交日期:相关说明',
	#
	`jd_jdjgttj_time` datetime DEFAULT NULL COMMENT '机电竣工图提交时间',
	`jd_jdjgttj_time_desc` varchar(500)  DEFAULT NULL COMMENT '机电竣工图提交时间:相关说明',
	#
	...
	`jd_rlzy_jdzfzr_desc`    varchar(500)) DEFAULT NULL COMMENT '人力资源:机电总负责人  相关说明',
	...
	`jd_rlzy_ktxfjpssj1_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:空调消防给排水设计1  相关说明',
	...
	`jd_rlzy_ktxfjpssj2_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:空调消防给排水设计2  相关说明',
	...
	`jd_rlzy_ktxfjpssj3_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:空调消防给排水设计3  相关说明',
	...
	`jd_rlzy_dqsj1_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:电气设计1  相关说明',
	...
	`jd_rlzy_dqsj2_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:电气设计2  相关说明',
	...
	`jd_rlzy_dqsj3_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:电气设计3  相关说明',
	...
	`jd_rlzy_jdgz1_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:机电工长1  相关说明',					
	...
	`jd_rlzy_jdgz2_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:机电工长2  相关说明',		
	...
	`jd_rlzy_jdgz3_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:机电工长3  相关说明',							
	#'机电管理部';

	#设计管理部
	`sj_sjfatj_time` datetime DEFAULT NULL COMMENT '设计方案提交日期',
	`sj_sjfatj_time_desc` varchar(500) DEFAULT NULL COMMENT '设计方案提交日期相关说明',
	#
	`sj_sjbpttj_time` datetime DEFAULT NULL COMMENT '设计报批图提交日期',
	`sj_sjbpttj_time_desc` varchar(500)  DEFAULT NULL COMMENT '设计报批图提交日期:相关说明',
	#
	`sj_zxsgt_time` datetime DEFAULT NULL COMMENT '装修施工图提交日期:计划日期',
	`sj_zxsgt_time_desc` varchar(500)  DEFAULT NULL COMMENT '装修施工图提交日期:相关说明',	
	#
	`sj_zxjgt_time` datetime DEFAULT NULL COMMENT '装修竣工图提交时间:计划日期',
	`sj_zxjgt_time_desc` varchar(500)  DEFAULT NULL COMMENT '装修竣工图提交时间:相关说明',	
	#
  ...
  `sj_rlzy_gjsjs1_choose`  tinyint(4) DEFAULT NULL COMMENT '人力资源:高级设计师1 工作比例',
	`sj_rlzy_gjsjs1_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:高级设计师1  相关说明',
	...
	`sj_rlzy_gjsjs2_desc`   varchar(500) DEFAULT NULL COMMENT '人力资源:高级设计师2  相关说明',
	...
	`sj_rlzy_xgsjs1_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:效果图设计师1  相关说明',
	...
	`sj_rlzy_xgsjs2_desc`   varchar(500) DEFAULT NULL COMMENT '人力资源:效果图设计师2  相关说明',
  ...
  `sj_rlzy_sgtfzr1_choose`  tinyint(4) DEFAULT NULL COMMENT '人力资源:施工图负责人1 工作比例',
	`sj_rlzy_sgtfzr1_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:施工图负责人1  相关说明',
	...
	`sj_rlzy_sgtfzr2_desc`   varchar(500) DEFAULT NULL COMMENT '人力资源:施工图负责人2  相关说明',
	...
	`sj_rlzy_sgtfzr3_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:施工图负责人3  相关说明',
	#'设计管理部';
  ...
  `sc_pro_trade_ot` char(20) DEFAULT NULL COMMENT '项目行业:其他',
	...
	`sc_fb_time_desc` varchar(500) DEFAULT NULL COMMENT '发标日期相关说明',
	`sc_hb_time` datetime DEFAULT NULL COMMENT '回标日期',
	`sc_hb_time_desc` varchar(500) DEFAULT NULL COMMENT '回标日期相关说明',
	`sc_htqd_time` datetime DEFAULT NULL COMMENT '合同签订日期',
	`sc_htqd_time_desc` varchar(500) DEFAULT NULL COMMENT '合同签订日期相关说明',
	...
	`sc_zb_reason_ot` varchar(500) DEFAULT NULL COMMENT '中标原因:其他',
	`sc_lb_reason_base` varchar(200) DEFAULT NULL COMMENT '落标原因:基本',
	`sc_lb_reason_ot` varchar(500) DEFAULT NULL COMMENT '落标原因:其他',
	`sc_ss_fgs` char(1) DEFAULT NULL COMMENT '项目实施分公司',
	`sc_sj_myd_1`      char(1) DEFAULT NULL COMMENT '客户满意度:设计1',
	`sc_sj_myd_1_desc` varchar(500) DEFAULT NULL COMMENT '客户满意度:设计1 相关说明',
	`sc_sj_myd_2`      char(1) DEFAULT NULL COMMENT '客户满意度:设计2',
	`sc_sj_myd_2_desc` varchar(500) DEFAULT NULL COMMENT '客户满意度:设计2 相关说明',
	`sc_sg_myd_1`      char(1) DEFAULT NULL COMMENT '客户满意度:施工1',
	`sc_sg_myd_1_desc` varchar(500) DEFAULT NULL COMMENT '客户满意度:施工1 相关说明',
	`sc_sg_myd_2`      char(1) DEFAULT NULL COMMENT '客户满意度:施工2',
	`sc_sg_myd_2_desc` varchar(500) DEFAULT NULL COMMENT '客户满意度:施工2 相关说明',
	#
	`sc_rlzy_scjl`    tinyint(4) DEFAULT NULL COMMENT '人力资源:市场经理',
	`sc_rlzy_scjl_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:市场经理 相关说明',
	`sc_rlzy_sczl`    tinyint(4) DEFAULT NULL COMMENT '人力资源:市场助理',
	`sc_rlzy_sczl_desc`    varchar(500) DEFAULT NULL COMMENT '人力资源:市场助理  相关说明',
	#
	#'市场管理部';
  ...
  `ys_kg_mll` double DEFAULT NULL COMMENT '开工毛利率',
	...
	`ys_cg_nkt_tj_time_desc` varchar(500) DEFAULT NULL COMMENT '采购内控单提交时间:相关说明',
	`ys_xc_nkt_tj_time` datetime DEFAULT NULL COMMENT '现场内控单提交时间',
	`ys_xc_nkt_tj_time_desc` varchar(500) DEFAULT NULL COMMENT '现场内控单提交时间:相关说明',
  `ys_jswc_time` datetime DEFAULT NULL COMMENT '项目结算完成时间',
 	`ys_jswc_time_desc` varchar(500) DEFAULT NULL COMMENT '项目结算完成时间:相关说明',
	...
	`ys_qq_sm`  varchar(500) DEFAULT NULL COMMENT '前期:说明',
	#对外报价
	...
	#相关说明
	`ys_zx_sm`   varchar(500) DEFAULT NULL COMMENT '装修:相关说明',
	`ys_dq_sm`   varchar(500) DEFAULT NULL COMMENT '电气:相关说明',
	`ys_kt_sm`   varchar(500) DEFAULT NULL COMMENT '空调:相关说明',
	`ys_xf_sm`   varchar(500) DEFAULT NULL COMMENT '消防:相关说明',
	`ys_jps_sm`  varchar(500) DEFAULT NULL COMMENT '给排水:相关说明',
	`ys_it_sm`   varchar(500) DEFAULT NULL COMMENT 'IT:相关说明',
	`ys_sec_sm`  varchar(500) DEFAULT NULL COMMENT 'SEC:相关说明',
	`ys_av_sm`   varchar(500) DEFAULT NULL COMMENT 'AV:相关说明', 
	#采购
	...
	`ys_rg_sm`    varchar(500) DEFAULT NULL COMMENT '直接人工成本:相关说明', 
	#其他说明
	`ys_qt_sm`    varchar(500) DEFAULT NULL COMMENT '其他:相关说明', 
