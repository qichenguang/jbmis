...
CREATE TABLE `jb_project` (
  ...
  `sh_zt_myd`         char(1) DEFAULT NULL COMMENT '售后客户满意度:总体',
	`sh_zt_myd_desc`    text DEFAULT NULL COMMENT '售后客户满意度:总体 相关说明',
	`sh_zt_gc_myd`      char(1) DEFAULT NULL COMMENT '售后客户满意度:总体 工程',
	`sh_zt_gc_myd_desc` text DEFAULT NULL COMMENT '售后客户满意度:总体 工程 相关说明',
	`sh_zt_zx_myd`      char(1) DEFAULT NULL COMMENT '售后客户满意度:总体 装修',
	`sh_zt_zx_myd_desc` text DEFAULT NULL COMMENT '售后客户满意度:总体 装修 相关说明',
	#售后满意度 售后
	`sh_sh_myd_1`      char(1) DEFAULT NULL COMMENT '客户满意度:售后1',
	`sh_sh_myd_1_desc` text DEFAULT NULL COMMENT '客户满意度:售后1 相关说明',
	`sh_sh_myd_2`      char(1) DEFAULT NULL COMMENT '客户满意度:售后2',
	`sh_sh_myd_2_desc` text DEFAULT NULL COMMENT '客户满意度:售后2 相关说明',
	`sh_sh_myd_3`      char(1) DEFAULT NULL COMMENT '客户满意度:售后3',
	`sh_sh_myd_3_desc` text DEFAULT NULL COMMENT '客户满意度:售后3 相关说明',
	`sh_sh_myd_4`      char(1) DEFAULT NULL COMMENT '客户满意度:售后4',
	`sh_sh_myd_4_desc` text DEFAULT NULL COMMENT '客户满意度:售后4 相关说明',
	`sh_sh_myd_5`      char(1) DEFAULT NULL COMMENT '客户满意度:售后5',
	`sh_sh_myd_5_desc` text DEFAULT NULL COMMENT '客户满意度:售后5 相关说明',
	#售后满意度 设计
	`sh_sj_myd_1`      char(1) DEFAULT NULL COMMENT '售后客户满意度:设计1',
	`sh_sj_myd_1_desc` text DEFAULT NULL COMMENT '售后客户满意度:设计1 相关说明',
	`sh_sj_myd_2`      char(1) DEFAULT NULL COMMENT '售后客户满意度:设计2',
	`sh_sj_myd_2_desc` text DEFAULT NULL COMMENT '售后客户满意度:设计2 相关说明',
	`sh_sj_myd_3`      char(1) DEFAULT NULL COMMENT '售后客户满意度:设计3',
	`sh_sj_myd_3_desc` text DEFAULT NULL COMMENT '售后客户满意度:设计3 相关说明',
	`sh_sj_myd_4`      char(1) DEFAULT NULL COMMENT '售后客户满意度:设计4',
	`sh_sj_myd_4_desc` text DEFAULT NULL COMMENT '售后客户满意度:设计4 相关说明',
	#售后满意度 施工
	`sh_sg_myd_1`      char(1) DEFAULT NULL COMMENT '售后客户满意度:施工1',
	`sh_sg_myd_1_desc` text DEFAULT NULL COMMENT '售后客户满意度:施工1 相关说明',
	`sh_sg_myd_2`      char(1) DEFAULT NULL COMMENT '售后客户满意度:施工2',
	`sh_sg_myd_2_desc` text DEFAULT NULL COMMENT '售后客户满意度:施工2 相关说明',
	#售后满意度 装修
	`sh_zx_myd_1`      char(1) DEFAULT NULL COMMENT '售后客户满意度:装修1',
	`sh_zx_myd_1_desc` text DEFAULT NULL COMMENT '售后客户满意度:装修1 相关说明',
	`sh_zx_myd_2`      char(1) DEFAULT NULL COMMENT '售后客户满意度:装修2',
	`sh_zx_myd_2_desc` text DEFAULT NULL COMMENT '售后客户满意度:装修2 相关说明',	
	`sh_zx_myd_3`      char(1) DEFAULT NULL COMMENT '售后客户满意度:装修3',
	`sh_zx_myd_3_desc` text DEFAULT NULL COMMENT '售后客户满意度:装修3 相关说明',
	`sh_zx_myd_4`      char(1) DEFAULT NULL COMMENT '售后客户满意度:装修4',
	`sh_zx_myd_4_desc` text DEFAULT NULL COMMENT '售后客户满意度:装修4 相关说明',	
	`sh_zx_myd_5`      char(1) DEFAULT NULL COMMENT '售后客户满意度:装修5',
	`sh_zx_myd_5_desc` text DEFAULT NULL COMMENT '售后客户满意度:装修5 相关说明',
	`sh_zx_myd_6`      char(1) DEFAULT NULL COMMENT '售后客户满意度:装修6',
	`sh_zx_myd_6_desc` text DEFAULT NULL COMMENT '售后客户满意度:装修6 相关说明',	
	`sh_zx_myd_7`      char(1) DEFAULT NULL COMMENT '售后客户满意度:装修7',
	`sh_zx_myd_7_desc` text DEFAULT NULL COMMENT '售后客户满意度:装修7 相关说明',
	`sh_zx_myd_8`      char(1) DEFAULT NULL COMMENT '售后客户满意度:装修8',
	`sh_zx_myd_8_desc` text DEFAULT NULL COMMENT '售后客户满意度:装修8 相关说明',		
	`sh_zx_myd_9`      char(1) DEFAULT NULL COMMENT '售后客户满意度:装修9',
	`sh_zx_myd_9_desc` text DEFAULT NULL COMMENT '售后客户满意度:装修9 相关说明',
	`sh_zx_myd_10`      char(1) DEFAULT NULL COMMENT '售后客户满意度:装修10',
	`sh_zx_myd_10_desc` text DEFAULT NULL COMMENT '售后客户满意度:装修10 相关说明',			
	#
	#
	#
  ...
  `sc_pro_trade_ot_name` char(20) DEFAULT NULL COMMENT '项目行业:其他行业的名称',
	...
	`sc_zt_myd_desc` text DEFAULT NULL COMMENT '客户满意度:总体 相关说明',
	#前期满意度
	`sc_qq_myd_1`      char(1) DEFAULT NULL COMMENT '客户满意度:前期1',
	`sc_qq_myd_1_desc` text DEFAULT NULL COMMENT '客户满意度:前期1 相关说明',
	`sc_qq_myd_2`      char(1) DEFAULT NULL COMMENT '客户满意度:前期2',
	`sc_qq_myd_2_desc` text DEFAULT NULL COMMENT '客户满意度:前期2 相关说明',
	`sc_qq_myd_3`      char(1) DEFAULT NULL COMMENT '客户满意度:前期3',
	`sc_qq_myd_3_desc` text DEFAULT NULL COMMENT '客户满意度:前期3 相关说明',
	`sc_qq_myd_4`      char(1) DEFAULT NULL COMMENT '客户满意度:前期4',
	`sc_qq_myd_4_desc` text DEFAULT NULL COMMENT '客户满意度:前期4 相关说明',
	#设计满意度
	`sc_sj_myd_1`      char(1) DEFAULT NULL COMMENT '客户满意度:设计1',
	`sc_sj_myd_1_desc` text DEFAULT NULL COMMENT '客户满意度:设计1 相关说明',
	`sc_sj_myd_2`      char(1) DEFAULT NULL COMMENT '客户满意度:设计2',
	`sc_sj_myd_2_desc` text DEFAULT NULL COMMENT '客户满意度:设计2 相关说明',
	`sc_sj_myd_3`      char(1) DEFAULT NULL COMMENT '客户满意度:设计3',
	`sc_sj_myd_3_desc` text DEFAULT NULL COMMENT '客户满意度:设计3 相关说明',
	`sc_sj_myd_4`      char(1) DEFAULT NULL COMMENT '客户满意度:设计4',
	`sc_sj_myd_4_desc` text DEFAULT NULL COMMENT '客户满意度:设计4 相关说明',
	`sc_sj_myd_5`      char(1) DEFAULT NULL COMMENT '客户满意度:设计5',
	`sc_sj_myd_5_desc` text DEFAULT NULL COMMENT '客户满意度:设计5 相关说明',
	#施工满意度
	`sc_sg_myd_1`      char(1) DEFAULT NULL COMMENT '客户满意度:施工1',
	`sc_sg_myd_1_desc` text DEFAULT NULL COMMENT '客户满意度:施工1 相关说明',
	`sc_sg_myd_2`      char(1) DEFAULT NULL COMMENT '客户满意度:施工2',
	`sc_sg_myd_2_desc` text DEFAULT NULL COMMENT '客户满意度:施工2 相关说明',
	`sc_sg_myd_3`      char(1) DEFAULT NULL COMMENT '客户满意度:施工3',
	`sc_sg_myd_3_desc` text DEFAULT NULL COMMENT '客户满意度:施工3 相关说明',
	`sc_sg_myd_4`      char(1) DEFAULT NULL COMMENT '客户满意度:施工4',
	`sc_sg_myd_4_desc` text DEFAULT NULL COMMENT '客户满意度:施工4 相关说明',
	`sc_sg_myd_5`      char(1) DEFAULT NULL COMMENT '客户满意度:施工5',
	`sc_sg_myd_5_desc` text DEFAULT NULL COMMENT '客户满意度:施工5 相关说明',
	`sc_sg_myd_6`      char(1) DEFAULT NULL COMMENT '客户满意度:施工6',
	`sc_sg_myd_6_desc` text DEFAULT NULL COMMENT '客户满意度:施工6 相关说明',
	`sc_sg_myd_7`      char(1) DEFAULT NULL COMMENT '客户满意度:施工7',
	`sc_sg_myd_7_desc` text DEFAULT NULL COMMENT '客户满意度:施工7 相关说明',
	`sc_sg_myd_8`      char(1) DEFAULT NULL COMMENT '客户满意度:施工8',
	`sc_sg_myd_8_desc` text DEFAULT NULL COMMENT '客户满意度:施工8 相关说明',	
	#
