...
CREATE TABLE `jb_cg_vo` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='采购材料 VO 表';

/*Data for the table `jb_cg_vo` */

insert  into `jb_cg_vo`(`id`,`pro_id`,`srctype`,`cg_name`,`cg_je`,`cg_reson`,`cg_desc`,`vo1_je`,`vo1_reson`,`vo1_desc`,`vo2_je`,`vo2_reson`,`vo2_desc`,`vo3_je`,`vo3_reson`,`vo3_desc`,`ys_pj`,`sj_pj`,`jd_pj`,`gc_pj`,`cg_pj`,`sh_pj`,`cg_gys_name`,`cg_ht_lx`) values (30,'pro_1','zxcg','天和',1,'A','1',2,'B','2',3,'C','3',4,'E','4','','C','','0','D','0','32','A'),(31,'pro_1','jdcg','机电',1,'A','1',2,'D','2',3,'D','3',4,'D','4','','','A','0','A','0','30','B'),(32,'pro_1','zxcg','蔬菜',3,'C','3',4,'D','4',6,'C','6',7,'D','7','','0','','0','0','0','30','E'),(33,'pro_1','jdcg','sadf',2,'B','2',0,'0','',0,'0','',0,'0','','','','C','0','D','0','32','C'),(34,'pro_1','qq','qq1',5,'C','qq1',0,'0','',0,'0','',0,'0','','','','','','','','',''),(35,'pro_1','qq','qq2',3,'H','sadfasf',1,'C','1',1,'E','2',0,'0','','','','','','','','','');
...
CREATE TABLE `jb_fb_vo` (
  ...
  `vo_desc` char(200) NOT NULL COMMENT 'VO 描述',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=39 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='分包VO表';

/*Data for the table `jb_fb_vo` */

insert  into `jb_fb_vo`(`id`,`pro_id`,`vo_type`,`vo_je`,`vo_reson`,`vo_desc`) values (30,'pro_1','zx',1,'A','zx'),(31,'pro_1','dq',2,'G','dq'),(32,'pro_1','kt',3,'B','kt'),(33,'pro_1','av',10,'E','av'),(34,'pro_1','av',9,'D','av'),(35,'pro_1','xf',2,'D','xf'),(36,'pro_1','jps',1,'F','jps'),(37,'pro_1','it',3,'E','3'),(38,'pro_1','sec',2,'C','22');
...
insert  into `jb_user`(`id`,`user_name`,`email`,`password`,`department`,`userflag`,`status`) values (30,'admin','admin@jinbi.com','111111','sc',2,2),(31,'ys','ys@jinbi.com','111111','ys',1,2),(32,'gc','gc@jinbi.com','111111','gc',1,2),(33,'sj','sj@jinbi.com','111111','sj',1,2),(34,'jd','jd@jinbi.com','111111','jd',1,2),(35,'cg','cg@jinbi.com','111111','cg',1,2),(36,'sh','sh@jinbi.com','111111','sh',1,2),(37,'sczl','sczl@jinbi.com','111111','sc',1