...
CREATE TABLE `jb_alert` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=96 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='报警表';

/*Data for the table `jb_alert` */

insert  into `jb_alert`(`id`,`pro_id`,`fgs`,`depsx`,`alert_msg`,`lx`,`msg_md5`,`alert_time`,`alert_day_num`,`alert_last_day`) values (92,'pro_1','A','gc','施工阶段 第 5 项:\n施工现场安全,安保管理及卫生整洁满意度:\n 基本满意',45,NULL,'2014-07-18 00:00:00',1,'2014-07-19 00:00:00'),(90,'pro_1','A','gc','施工阶段 第 1 项:\n装修质量满意度:\n 基本满意',41,NULL,'2014-07-18 00:00:00',1,'2014-07-19 00:00:00'),(88,'pro_1','A','gc,sj,jd,ys,cg,gl','设计阶段 第 3 项:\n总体设计是否符合贵司的设计标准及空间需求:\n 不太满意或不满意',33,NULL,'2014-07-18 00:00:00',1,'2014-07-19 00:00:00'),(91,'pro_1','A','gc,sj,jd,ys,cg,gl','施工阶段 第 3 项:\n工程进度满意度:\n 不太满意或不满意',43,NULL,'2014-07-18 00:00:00',1,'2014-07-19 00:00:00'),(89,'pro_1','A','sj,jd','设计阶段 第 5 项:\n设计人员的专业性及配合度:\n 基本满意',35,NULL,'2014-07-18 00:00:00',1,'2014-07-19 00:00:00'),(87,'pro_1','A','sj,jd','设计阶段 第 1 项:\n装修设计是否满足您的功能需求:\n 基本满意',31,NULL,'2014-07-18 00:00:00',1,'2014-07-19 00:00:00'),(86,'pro_1','A','gc,jd,sj','设计部竣工图时间(2015-03-20) 晚于 项目完工时间(2014-08-01) + 2周',7,NULL,'2014-07-18 00:00:00',1,'2014-07-19 00:00:00'),(93,'pro_1','A','gc,sj,jd,ys,cg,gl','售后服务内容 第 2 项:\n维修人员上门维修服务态度:\n 不太满意或不满意',52,NULL,'2014-07-18 00:00:00',1,'2014-07-19 00:00:00'),(94,'pro_1','A','gc,sj,jd,ys,cg,gl','售后服务内容 第 5 项:\n对金碧整体售后维修服务满意度:\n 不太满意或不满意',55,NULL,'2014-07-18 00:00:00',1,'2014-07-19 00:00:00'),(95,'pro_1','A','gc,sj,jd,ys,cg,gl','装修细节服务内容 第 10 项:\n地面材料使用情况满意度:\n 不太满意或不满意',90,NULL,'2014-07-18 00:00:00',1,'2014-07-19 00:00:00');
...
CREATE TABLE `jb_gys_fbgl` (
  ...
  `sh_pj` char(1) NOT NULL COMMENT '评价：售后部',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=86 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='供应商管理 分包管理表';

/*Data for the table `jb_gys_fbgl` */

insert  into `jb_gys_fbgl`(`id`,`pro_id`,`fb_lx`,`ys_fbs_name`,`ys_fb_ht_lx`,`ys_pj`,`sj_pj`,`jd_pj`,`gc_pj`,`cg_pj`,`sh_pj`) values (76,'pro_1','sec','','','','','','','',''),(75,'pro_1','it','','','','','','','',''),(74,'pro_1','jps','','','','','','','',''),(73,'pro_1','xf','','','','','','','',''),(72,'pro_1','kt','32','E','D','0','0','0','','0'),(71,'pro_1','dq','31','C','0','0','0','0','','0'),(70,'pro_1','zx','32','B','A','0','0','0','','0'),(77,'pro_1','av','','','','','','','',''),(78,'pro_2','zx','','','','','','','',''),(79,'pro_2','dq','','','','','','','',''),(80,'pro_2','kt','','','','','','','',''),(81,'pro_2','xf','','','','','','','',''),(82,'pro_2','jps','','','','','','','',''),(83,'pro_2','it','','','','','','','',''),(84,'pro_2','sec','','','','','','','',''),(85,'pro_2','av','','','','','','','','');
...
CREATE TABLE `jb_project` (
  ...
  `sc_sj_myd_1_desc` text COMMENT '客户满意度:设计1 相关说明',
  `sc_sj_myd_2` char(1) DEFAULT NULL COMMENT '客户满意度:设计2',
  `sc_sj_myd_2_desc` text COMMENT '客户满意度:设计2 相关说明',
  `sc_sg_myd_1` char(1) DEFAULT NULL COMMENT '客户满意度:施工1',
  `sc_sg_myd_1_desc` text COMMENT '客户满意度:施工1 相关说明',
  `sc_sg_myd_2` char(1) DEFAULT NULL COMMENT '客户满意度:施工2',
  `sc_sg_myd_2_desc` text COMMENT '客户满意度:施工2 相关说明',
  ...
  `sc_qq_myd_1` char(1) DEFAULT NULL COMMENT '客户满意度:前期1',
  `sc_qq_myd_1_desc` text COMMENT '客户满意度:前期1 相关说明',
  `sc_qq_myd_2` char(1) DEFAULT NULL COMMENT '客户满意度:前期2',
  `sc_qq_myd_2_desc` text COMMENT '客户满意度:前期2 相关说明',
  `sc_qq_myd_3` char(1) DEFAULT NULL COMMENT '客户满意度:前期3',
  `sc_qq_myd_3_desc` text COMMENT '客户满意度:前期3 相关说明',
  `sc_qq_myd_4` char(1) DEFAULT NULL COMMENT '客户满意度:前期4',
  `sc_qq_myd_4_desc` text COMMENT '客户满意度:前期4 相关说明',
  `sc_sj_myd_3` char(1) DEFAULT NULL COMMENT '客户满意度:设计3',
  `sc_sj_myd_3_desc` text COMMENT '客户满意度:设计3 相关说明',
  `sc_sj_myd_4` char(1) DEFAULT NULL COMMENT '客户满意度:设计4',
  `sc_sj_myd_4_desc` text COMMENT '客户满意度:设计4 相关说明',
  `sc_sj_myd_5` char(1) DEFAULT NULL COMMENT '客户满意度:设计5',
  `sc_sj_myd_5_desc` text COMMENT '客户满意度:设计5 相关说明',
  `sc_sg_myd_3` char(1) DEFAULT NULL COMMENT '客户满意度:施工3',
  `sc_sg_myd_3_desc` text COMMENT '客户满意度:施工3 相关说明',
  `sc_sg_myd_4` char(1) DEFAULT NULL COMMENT '客户满意度:施工4',
  `sc_sg_myd_4_desc` text COMMENT '客户满意度:施工4 相关说明',
  `sc_sg_myd_5` char(1) DEFAULT NULL COMMENT '客户满意度:施工5',
  `sc_sg_myd_5_desc` text COMMENT '客户满意度:施工5 相关说明',
  `sc_sg_myd_6` char(1) DEFAULT NULL COMMENT '客户满意度:施工6',
  `sc_sg_myd_7` char(1) DEFAULT NULL COMMENT '客户满意度:施工7',
  `sc_sg_myd_8` char(1) DEFAULT NULL COMMENT '客户满意度:施工8',
  `sc_sg_myd_8_desc` text COMMENT '客户满意度:施工8 相关说明',
  `sc_sg_myd_6_desc` text COMMENT '客户满意度:施工6 相关说明',
  `sc_sg_myd_7_desc` text COMMENT '客户满意度:施工7 相关说明',
  `sh_sh_myd_3` char(1) DEFAULT NULL COMMENT '客户满意度:售后3',
  `sh_sh_myd_3_desc` text COMMENT '客户满意度:售后3 相关说明',
  `sh_sh_myd_4` char(1) DEFAULT NULL COMMENT '客户满意度:售后4',
  `sh_sh_myd_4_desc` text COMMENT '客户满意度:售后4 相关说明',
  `sh_sh_myd_5` char(1) DEFAULT NULL COMMENT '客户满意度:售后5',
  `sh_sh_myd_5_desc` text COMMENT '客户满意度:售后5 相关说明',
  `sh_sj_myd_1` char(1) DEFAULT NULL COMMENT '售后客户满意度:设计1',
  `sh_sj_myd_1_desc` text COMMENT '售后客户满意度:设计1 相关说明',
  `sh_sj_myd_2` char(1) DEFAULT NULL COMMENT '售后客户满意度:设计2',
  `sh_sj_myd_2_desc` text COMMENT '售后客户满意度:设计2 相关说明',
  `sh_sj_myd_3` char(1) DEFAULT NULL COMMENT '售后客户满意度:设计3',
  `sh_sj_myd_3_desc` text COMMENT '售后客户满意度:设计3 相关说明',
  `sh_sj_myd_4` char(1) DEFAULT NULL COMMENT '售后客户满意度:设计4',
  `sh_sj_myd_4_desc` text COMMENT '售后客户满意度:设计4 相关说明',
  `sh_sg_myd_1` char(1) DEFAULT NULL COMMENT '售后客户满意度:施工1',
  `sh_sg_myd_1_desc` text COMMENT '售后客户满意度:施工1 相关说明',
  `sh_sg_myd_2` char(1) DEFAULT NULL COMMENT '售后客户满意度:施工2',
  `sh_sg_myd_2_desc` text COMMENT '售后客户满意度:施工2 相关说明',
  `sh_zx_myd_1` char(1) DEFAULT NULL COMMENT '售后客户满意度:装修1',
  `sh_zx_myd_1_desc` text COMMENT '售后客户满意度:装修1 相关说明',
  `sh_zx_myd_2` char(1) DEFAULT NULL COMMENT '售后客户满意度:装修2',
  `sh_zx_myd_3_desc` text COMMENT '售后客户满意度:装修3 相关说明',
  `sh_zx_myd_4` char(1) DEFAULT NULL COMMENT '售后客户满意度:装修4',
  `sh_zx_myd_5_desc` text COMMENT '售后客户满意度:装修5 相关说明',
  `sh_zx_myd_6` char(1) DEFAULT NULL COMMENT '售后客户满意度:装修6',
  `sh_zx_myd_7_desc` text COMMENT '售后客户满意度:装修7 相关说明',
  `sh_zx_myd_8` char(1) DEFAULT NULL COMMENT '售后客户满意度:装修8',
  `sh_zx_myd_8_desc` text COMMENT '售后客户满意度:装修8 相关说明',
  `sh_zx_myd_2_desc` text COMMENT '售后客户满意度:装修2 相关说明',
  `sh_zx_myd_3` char(1) DEFAULT NULL COMMENT '售后客户满意度:装修3',
  `sh_zx_myd_4_desc` text COMMENT '售后客户满意度:装修4 相关说明',
  `sh_zx_myd_5` char(1) DEFAULT NULL COMMENT '售后客户满意度:装修5',
  `sh_zx_myd_6_desc` text COMMENT '售后客户满意度:装修6 相关说明',
  `sh_zx_myd_7` char(1) DEFAULT NULL COMMENT '售后客户满意度:装修7',
  `sh_zx_myd_9` char(1) DEFAULT NULL COMMENT '售后客户满意度:装修9',
  `sh_zx_myd_9_desc` text COMMENT '售后客户满意度:装修9 相关说明',
  `sh_zx_myd_10` char(1) DEFAULT NULL COMMENT '售后客户满意度:装修10',
  `sh_zx_myd_10_desc` text COMMENT '售后客户满意度:装修10 相关说明',
  `sc_zt_myd` char(1) DEFAULT NULL COMMENT '客户满意度:总体',
  `sc_zt_myd_desc` text COMMENT '客户满意度:总体 相关说明',
  `sh_zt_myd` char(1) DEFAULT NULL COMMENT '售后客户满意度:总体',
  `sh_zt_myd_desc` text COMMENT '售后客户满意度:总体 相关说明',
  `sh_zt_gc_myd` char(1) DEFAULT NULL COMMENT '售后客户满意度:总体 工程',
  `sh_zt_gc_myd_desc` text COMMENT '售后客户满意度:总体 工程 相关说明',
  `sh_zt_zx_myd` char(1) DEFAULT NULL COMMENT '售后客户满意度:总体 装修',
  `sh_zt_zx_myd_desc` text COMMENT '售后客户满意度:总体 装修 相关说明',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='项目总表';

/*Data for the table `jb_project` */

insert  into `jb_project`(`id`,`pro_id`,`sh_yjtime`,`sh_zbjtime`,`sh_zb_sub_detail`,`sh_sh_myd_1`,`sh_sh_myd_1_desc`,`sh_sh_myd_2`,`sh_sh_myd_2_desc`,`sh_myd_all`,`sh_myd_sub_detail`,`hr_follow_man`,`cg_clbp_wc_time`,`cg_clbp_wc_time_desc`,`cg_buy_gckc_all_amt`,`cg_buy_gcrgf_all_amt`,`cg_buy_zscl_sub_detail`,`cg_buy_jdsb_sub_detail`,`cg_cljg_mon_pay_rate`,`cg_cljg_next_mon_pay_rate`,`cg_clzb_pay_rate`,`cg_rlzy_cgr1`,`cg_rlzy_cgr1_choose`,`cg_rlzy_cgr1_desc`,`cg_rlzy_cgr2`,`cg_rlzy_cgr2_choose`,`cg_rlzy_cgr2_desc`,`gc_htqd_time`,`gc_customer_fkzq`,`gc_pay_sh_pzsc`,`gc_hetong_first_pay_rate`,`gc_jhkg_time`,`gc_jhjg_time`,`gc_dsbptj_jh_time`,`gc_dsbptj_sj_time`,`gc_dsbptj_time_desc`,`gc_dsbppz_time`,`gc_dsbppz_time_desc`,`gc_xfbptj_jh_time`,`gc_xfbptj_sj_time`,`gc_xfbptj_time_desc`,`gc_xfbppz_time`,`gc_xfbppz_time_desc`,`gc_kg_jh_time`,`gc_kg_sj_time`,`gc_kg_time_desc`,`gc_sl_time`,`gc_sl_time_desc`,`gc_xfystj_jh_time`,`gc_xfystj_sj_time`,`gc_xfystj_time_desc`,`gc_xfyspz_time`,`gc_xfyspz_time_desc`,`gc_gqyj_jh_time`,`gc_gqyj_sj_time`,`gc_gqyj_time_desc`,`gc_jfyj_jh_time`,`gc_jfyj_sj_time`,`gc_jfyj_time_desc`,`gc_thyj_jh_time`,`gc_thyj_sj_time`,`gc_thyj_time_desc`,`gc_xmwg_khys_jh_time`,`gc_xmwg_khys_sj_time`,`gc_xmwg_khys_time_desc`,`gc_xmyj_yyzbqjs_time`,`gc_xmyj_yyzbqjs_time_desc`,`gc_jgzltj_time`,`gc_jgzltj_time_desc`,`gc_khbj_jh_time`,`gc_khbj_sj_time`,`gc_khbj_time_desc`,`gc_yjsh_jh_time`,`gc_yjsh_sj_time`,`gc_yjsh_time_desc`,`gc_zbqm_time`,`gc_zbqm_time_desc`,`gc_gcxg_date_detail`,`gc_jgxg_detail`,`gc_rlzy_xmzj`,`gc_rlzy_xmzj_choose`,`gc_rlzy_xmzj_desc`,`gc_rlzy_xmxc1`,`gc_rlzy_xmxc1_choose`,`gc_rlzy_xmxc1_desc`,`gc_rlzy_xmxc2`,`gc_rlzy_xmxc2_choose`,`gc_rlzy_xmxc2_desc`,`gc_rlzy_zxgz1`,`gc_rlzy_zxgz1_choose`,`gc_rlzy_zxgz1_desc`,`gc_rlzy_zxgz2`,`gc_rlzy_zxgz2_choose`,`gc_rlzy_zxgz2_desc`,`gc_rlzy_zxgz3`,`gc_rlzy_zxgz3_choose`,`gc_rlzy_zxgz3_desc`,`gc_rlzy_aqy1`,`gc_rlzy_aqy1_choose`,`gc_rlzy_aqy1_desc`,`gc_rlzy_aqy2`,`gc_rlzy_aqy2_choose`,`gc_rlzy_aqy2_desc`,`gc_rlzy_aqy3`,`gc_rlzy_aqy3_choose`,`gc_rlzy_aqy3_desc`,`gc_rlzy_kfbj1`,`gc_rlzy_kfbj1_choose`,`gc_rlzy_kfbj1_desc`,`gc_rlzy_kfbj2`,`gc_rlzy_kfbj2_choose`,`gc_rlzy_kfbj2_desc`,`gc_rlzy_gczl`,`gc_rlzy_gczl_choose`,`gc_rlzy_gczl_desc`,`gc_xmry_detail`,`gc_fee_detail`,`jd_jdfatj_time`,`jd_jdfatj_time_desc`,`jd_jdbpttj_time`,`jd_jdbpttj_time_desc`,`jd_jdsgttj_time`,`jd_jdsgttj_time_desc`,`jd_jdjgttj_time`,`jd_jdjgttj_time_desc`,`jd_rlzy_jdzfzr`,`jd_rlzy_jdzfzr_choose`,`jd_rlzy_jdzfzr_desc`,`jd_rlzy_ktxfjpssj1`,`jd_rlzy_ktxfjpssj1_choose`,`jd_rlzy_ktxfjpssj1_desc`,`jd_rlzy_ktxfjpssj2`,`jd_rlzy_ktxfjpssj2_choose`,`jd_rlzy_ktxfjpssj2_desc`,`jd_rlzy_ktxfjpssj3`,`jd_rlzy_ktxfjpssj3_choose`,`jd_rlzy_ktxfjpssj3_desc`,`jd_rlzy_dqsj1`,`jd_rlzy_dqsj1_choose`,`jd_rlzy_dqsj1_desc`,`jd_rlzy_dqsj2`,`jd_rlzy_dqsj2_choose`,`jd_rlzy_dqsj2_desc`,`jd_rlzy_dqsj3`,`jd_rlzy_dqsj3_choose`,`jd_rlzy_dqsj3_desc`,`jd_rlzy_jdgz1`,`jd_rlzy_jdgz1_choose`,`jd_rlzy_jdgz1_desc`,`jd_rlzy_jdgz2`,`jd_rlzy_jdgz2_choose`,`jd_rlzy_jdgz2_desc`,`jd_rlzy_jdgz3`,`jd_rlzy_jdgz3_choose`,`jd_rlzy_jdgz3_desc`,`jd_tjsj_date_detail`,`jd_jdgl_detail`,`jd_kt_xf_jps_rate`,`jd_dq_rate`,`sj_sjfatj_time`,`sj_sjfatj_time_desc`,`sj_sjbpttj_time`,`sj_sjbpttj_time_desc`,`sj_zxsgt_time`,`sj_zxsgt_time_desc`,`sj_zxjgt_time`,`sj_zxjgt_time_desc`,`sj_rlzy_gjsjs1`,`sj_rlzy_gjsjs1_choose`,`sj_rlzy_gjsjs1_desc`,`sj_rlzy_gjsjs2`,`sj_rlzy_gjsjs2_choose`,`sj_rlzy_gjsjs2_desc`,`sj_rlzy_xgsjs1`,`sj_rlzy_xgsjs1_choose`,`sj_rlzy_xgsjs1_desc`,`sj_rlzy_xgsjs2`,`sj_rlzy_xgsjs2_choose`,`sj_rlzy_xgsjs2_desc`,`sj_rlzy_sgtfzr1`,`sj_rlzy_sgtfzr1_choose`,`sj_rlzy_sgtfzr1_desc`,`sj_rlzy_sgtfzr2`,`sj_rlzy_sgtfzr2_choose`,`sj_rlzy_sgtfzr2_desc`,`sj_rlzy_sgtfzr3`,`sj_rlzy_sgtfzr3_choose`,`sj_rlzy_sgtfzr3_desc`,`sj_tjsj_date_detail`,`sj_sjgl_detail`,`sc_pro_name`,`sc_pro_qx`,`sc_pro_type`,`sc_pro_trade_base`,`sc_pro_trade_ot`,`sc_cus_name`,`sc_cus_type`,`sc_cus_t_1`,`sc_cus_t_2`,`sc_mag_company_base`,`sc_mag_company_ot`,`sc_compety_company_base`,`sc_compety_company_ot`,`sc_pro_city`,`sc_pro_address`,`sc_invest_type`,`sc_fb_time`,`sc_fb_time_desc`,`sc_hb_time`,`sc_hb_time_desc`,`sc_htqd_time`,`sc_htqd_time_desc`,`sc_tbcl_fxh`,`sc_zb_flag`,`sc_zb_time`,`sc_zb_time_desc`,`sc_zb_amt`,`sc_zb_reason_base`,`sc_zb_reason_ot`,`sc_lb_reason_base`,`sc_lb_reason_ot`,`sc_ss_fgs`,`sc_sj_myd_1`,`sc_sj_myd_1_desc`,`sc_sj_myd_2`,`sc_sj_myd_2_desc`,`sc_sg_myd_1`,`sc_sg_myd_1_desc`,`sc_sg_myd_2`,`sc_sg_myd_2_desc`,`sc_rlzy_scjl`,`sc_rlzy_scjl_desc`,`sc_rlzy_sczl`,`sc_rlzy_sczl_desc`,`sc_myd_sub_detail`,`sc_tbtd_detail`,`ys_cw_bh`,`ys_hetong_amt`,`ys_xm_mj`,`ys_xm_jmj`,`ys_tb_mll`,`ys_kg_mll`,`ys_cg_nk_amt`,`ys_xc_nk_amt`,`ys_cg_nkt_tj_time`,`ys_cg_nkt_tj_time_desc`,`ys_xc_nkt_tj_time`,`ys_xc_nkt_tj_time_desc`,`ys_jswc_time`,`ys_jswc_time_desc`,`ys_qt_zjcb_amt`,`ys_zx_sub_detail`,`ys_dq_sub_detail`,`ys_kt_sub_detail`,`ys_xf_sub_detail`,`ys_jps_sub_detail`,`ys_it_sub_detail`,`ys_af_sub_detail`,`ys_av_sub_detail`,`ys_rlzy_ysy1`,`ys_rlzy_ysy1_choose`,`ys_rlzy_ysy1_desc`,`ys_rlzy_ysy2`,`ys_rlzy_ysy2_choose`,`ys_rlzy_ysy2_desc`,`ys_rlzy_ysy3`,`ys_rlzy_ysy3_choose`,`ys_rlzy_ysy3_desc`,`ys_ysgl_detail`,`status`,`ht_xmcwbh`,`ys_zx_dwbj`,`ys_dq_dwbj`,`ys_kt_dwbj`,`ys_xf_dwbj`,`ys_jps_dwbj`,`ys_it_dwbj`,`ys_sec_dwbj`,`ys_av_dwbj`,`ys_zx_nkje`,`ys_dq_nkje`,`ys_kt_nkje`,`ys_xf_nkje`,`ys_jps_nkje`,`ys_it_nkje`,`ys_sec_nkje`,`ys_av_nkje`,`ys_zx_sjcb`,`ys_dq_sjcb`,`ys_kt_sjcb`,`ys_xf_sjcb`,`ys_jps_sjcb`,`ys_it_sjcb`,`ys_sec_sjcb`,`ys_av_sjcb`,`ys_zx_sm`,`ys_dq_sm`,`ys_kt_sm`,`ys_xf_sm`,`ys_jps_sm`,`ys_it_sm`,`ys_sec_sm`,`ys_av_sm`,`ys_cg_all_dwbj`,`ys_cg_all_nkje`,`cg_gckc_sjcb`,`cg_gcrgf_sjcb`,`cg_gckc_sjcb_vo`,`cg_gcrgf_sjcb_vo`,`cg_zxclcg_sm`,`cg_jdsbcg_sm`,`cg_gckc_sm`,`cg_gcrgf_sm`,`ys_qq_dwbj`,`ys_qq_customer_vo`,`ys_qq_nkje`,`ys_qq_sm`,`ys_rg_dwbj`,`ys_rg_nkje`,`ys_rg_sm`,`ys_qt_sm`,`sc_mag_company`,`sc_pro_trade`,`sc_compety_company`,`ys_qt_dwbj`,`ys_qt_customer_vo`,`ys_qt_nkje`,`ys_qt_sjcb`,`ys_qt_vo`,`fgs`,`sc_pro_trade_ot_name`,`sc_qq_myd_1`,`sc_qq_myd_1_desc`,`sc_qq_myd_2`,`sc_qq_myd_2_desc`,`sc_qq_myd_3`,`sc_qq_myd_3_desc`,`sc_qq_myd_4`,`sc_qq_myd_4_desc`,`sc_sj_myd_3`,`sc_sj_myd_3_desc`,`sc_sj_myd_4`,`sc_sj_myd_4_desc`,`sc_sj_myd_5`,`sc_sj_myd_5_desc`,`sc_sg_myd_3`,`sc_sg_myd_3_desc`,`sc_sg_myd_4`,`sc_sg_myd_4_desc`,`sc_sg_myd_5`,`sc_sg_myd_5_desc`,`sc_sg_myd_6`,`sc_sg_myd_7`,`sc_sg_myd_8`,`sc_sg_myd_8_desc`,`sc_sg_myd_6_desc`,`sc_sg_myd_7_desc`,`sh_sh_myd_3`,`sh_sh_myd_3_desc`,`sh_sh_myd_4`,`sh_sh_myd_4_desc`,`sh_sh_myd_5`,`sh_sh_myd_5_desc`,`sh_sj_myd_1`,`sh_sj_myd_1_desc`,`sh_sj_myd_2`,`sh_sj_myd_2_desc`,`sh_sj_myd_3`,`sh_sj_myd_3_desc`,`sh_sj_myd_4`,`sh_sj_myd_4_desc`,`sh_sg_myd_1`,`sh_sg_myd_1_desc`,`sh_sg_myd_2`,`sh_sg_myd_2_desc`,`sh_zx_myd_1`,`sh_zx_myd_1_desc`,`sh_zx_myd_2`,`sh_zx_myd_3_desc`,`sh_zx_myd_4`,`sh_zx_myd_5_desc`,`sh_zx_myd_6`,`sh_zx_myd_7_desc`,`sh_zx_myd_8`,`sh_zx_myd_8_desc`,`sh_zx_myd_2_desc`,`sh_zx_myd_3`,`sh_zx_myd_4_desc`,`sh_zx_myd_5`,`sh_zx_myd_6_desc`,`sh_zx_myd_7`,`sh_zx_myd_9`,`sh_zx_myd_9_desc`,`sh_zx_myd_10`,`sh_zx_myd_10_desc`,`sc_zt_myd`,`sc_zt_myd_desc`,`sh_zt_myd`,`sh_zt_myd_desc`,`sh_zt_gc_myd`,`sh_zt_gc_myd_desc`,`sh_zt_zx_myd`,`sh_zt_zx_myd_desc`) values (3,'pro_1',NULL,NULL,NULL,'B','在我看来，很多国内创投就像上面故事里的哥萨克人，他们其实不知道怎么把事情做好，只是下命令，让创业者自','D','我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.25,0.3,0.05,70,10,'1',71,90,'2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2014-06-17 00:00:00','2014-07-31 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2014-06-17 00:00:00','2014-06-10 00:00:00',NULL,'2014-06-29 00:00:00','2014-08-01 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2014-06-26 00:00:00',NULL,NULL,NULL,49,NULL,'gc bu',NULL,NULL,NULL,NULL,NULL,NULL,51,40,'',52,60,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.5,0,NULL,NULL,NULL,NULL,NULL,NULL,'2015-03-20 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'北京项目',NULL,'D','L',NULL,'国际展览中心',NULL,'0','A',NULL,NULL,'','qcg','北京市,市辖区,石景山区','建国路','C',NULL,NULL,NULL,NULL,NULL,NULL,'0','B','2014-07-16 00:00:00',NULL,NULL,'[\"A\",\"C\",\"F\"]','FT社评：要遏制朝鲜核计划，中国加大压力是不可缺少的一环。中国国家主席习近平未访朝鲜先访韩国，令人对朝鲜半岛局势好转产生期盼。但若把此行放在东亚地缘政治紧张加剧的大背景下看，有些迹象却令人担忧asfasdfasdfdfasfasdfsadfasdfasdfasdfasdsdasfadfasdfasasdfasdfasdfas\nadfasdfasdfasdfasdf\nasdfasdfasdf\nasd','[\"B\",\"C\"]','asdfasfasdfas\nasdflasjfa\n\nda\nf\nasdf\n\nasf\na','E','C','这是我去年写的一篇文章，昨天赛前修改了一下：asdfasf\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝，','B','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','B','这是我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝，','C','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢',30,'检索或设置对象的高度。\n对于img对象来说，仅指定此属性，其width值将根据图片源尺寸等比例缩放。\n对应的脚本特性为height。其值为一字符串，所以不可用于脚本(Scripts)中的计算。请使用style对象的posHeight，pixelHeight，以及对象的offsetHeight等特性。请参阅我编写的其他书目。\n按照样式表的规则，对象的实际高度为其下列属性值之和：\nmargin-top',NULL,'这是我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝，',NULL,NULL,NULL,2000,10000,NULL,15,NULL,NULL,NULL,'2014-06-18 00:00:00',NULL,NULL,NULL,'2014-06-26 00:00:00','没有值jkjk\njkjkk\nj\n\njk\n\n\n\n\n\n\n\nsd\ndf\nsds',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,31,10,NULL,31,20,NULL,38,70,NULL,NULL,2,'xmcwbh',10,2,4,4,5,6.2,7,27,1,0.9,3,4,3,6,6,8,5,2,3,2,5,6,7,8,'1','2','3','4','5','6','7','8',1,0.5,2,3,2,4,'1','2','3','4',4,1,1.5,'qq',10,5,'rg','qt','CUSHMAN','物流',NULL,10,2,4,5,4,'A','其他行业','B','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','C','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','B','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','C','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','E','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','A','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','C','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','B','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','E','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','C','是我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝，','B','C','A','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','A','我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝','C','是我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝，','E','是我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝，','A','是我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝，','C','我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝','C','我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝','B','是我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝，','B','是我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝，','A','是我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝，','A','我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝','B','ALTER TABLE `jb_project` add `sh_zx_myd_9`      char(1) DEFAULT NULL COMMENT \'售后客户满意度:装修9\';\nALTER TABLE `jb_project` add `sh_zx_myd_9_desc` text DEFAULT NULL COMMENT \'售后客户满意度:装修9 相关说明\';\nALTER TABLE `jb_project` add `sh_zx_myd_10`      char(1) DEFAULT NULL COMMENT \'售后客户满意度:装修10\';\nALTER TABLE `jb_project` add `sh_zx_myd_10_desc` text DEFAULT NULL COMMENT \'售后客户满意度:装修10 相关说明\';','C','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','A','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','C','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','我去年写的一篇文章，昨天赛前修改了一下：\n\n2014 世界杯我这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢的东西是足球，最讨厌的东西是限速牌，做学术报告不用激光笔而用路边捡的一米多长带刺的树枝','C','ALTER TABLE `jb_project` add `sh_zx_myd_9`      char(1) DEFAULT NULL COMMENT \'售后客户满意度:装修9\';\nALTER TABLE `jb_project` add `sh_zx_myd_9_desc` text DEFAULT NULL COMMENT \'售后客户满意度:装修9 相关说明\';\nALTER TABLE `jb_project` add `sh_zx_myd_10`      char(1) DEFAULT NULL COMMENT \'售后客户满意度:装修10\';\nALTER TABLE `jb_project` add `sh_zx_myd_10_desc` text DEFAULT NULL COMMENT \'售后客户满意度:装修10 相关说明\';','C','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','A','B','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','E','这个伪球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n\n这位智利大叔真是个人物，他最喜欢','A','球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…\n','B','球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…','C','球迷为什么支持智利队\n\n这其中的原因要从跟我一个办公室的智利同（da）学（shu）说起。他曾经在智利总统顾问团里工作，他申请的推荐信是智利教育部长写的。每次想到这里就觉得当初肯定是哪个教授手一抖才录的我…',NULL,NULL),(4,'pro_2',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.25,0.3,0.05,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2014-07-09 00:00:00','2014-08-31 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2014-10-17 00:00:00','2014-11-30 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,74,NULL,'sddssddssdsd',49,60,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.5,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'天津项目',NULL,'F','D',NULL,'大西洋',NULL,'0','C',NULL,NULL,NULL,NULL,NULL,NULL,'B','2014-06-11 00:00:00','没有值','2014-06-12 00:00:00','没有值',NULL,NULL,'0','B','2014-05-14 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,7000,5000,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'A',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,'pro_3',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.25,0.3,0.05,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.5,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'南京项目',NULL,NULL,NULL,NULL,NULL,NULL,'0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(6,'pro_4',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.25,0.3,0.05,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.5,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'南京项目',NULL,NULL,NULL,NULL,NULL,NULL,'0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(7,'pro_sh_1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.25,0.3,0.05,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.5,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'上海项目',NULL,NULL,NULL,NULL,NULL,NULL,'0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'B',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `jb_user` (
  ...
  `fgs` char(2) DEFAULT NULL COMMENT '分公司',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=82 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='用户表';

/*Data for the table `jb_user` */

insert  into `jb_user`(`id`,`user_name`,`email`,`password`,`department`,`userflag`,`status`,`salary`,`fgs`) values (30,'admin','admin@jinbi.com','111111','sc',2,2,NULL,'A'),(31,'ys','ys@jinbi.com','111111','ys',1,2,NULL,'A'),(32,'gc','gc@jinbi.com','111111','gc',1,2,NULL,'A'),(33,'sj','sj@jinbi.com','111111','sj',1,2,NULL,'A'),(34,'jd','jd@jinbi.com','111111','jd',1,2,NULL,'A'),(35,'cg','cg@jinbi.com','111111','cg',1,2,NULL,'A'),(36,'sh','sh@jinbi.com','111111','sh',1,2,NULL,'A'),(37,'sczl','sczl@jinbi.com','111111','sc',1,2,NULL,'A'),(38,'ys1','ys1@jinbi.com','111111','ys',1,2,NULL,'A'),(39,'ys2','ys2@jinbi.com','111111','ys',1,2,NULL,'A'),(40,'ys3','ys3@jinbi.com','111111','ys',1,2,NULL,'A'),(41,'gjsjs1','gjsjs1@jinbi.com','111111','sj',1,2,NULL,'A'),(42,'gjsjs2','gjsjs2@jinbi.com','111111','sj',1,2,NULL,'A'),(43,'xgtsjs1','xgtsjs1@jinbi.com','111111','sj',1,2,NULL,'A'),(44,'xgtsjs2','xgtsjs2@jinbi.com','111111','sj',1,2,NULL,'A'),(45,'sgtfzr1','sgtfzr1@jinbi.com','111111','sj',1,2,NULL,'A'),(46,'sgtfzr2','sgtfzr2@jinbi.com','111111','sj',1,2,NULL,'A'),(47,'sgtfzr3','sgtfzr3@jinbi.com','111111','sj',1,2,NULL,'A'),(48,'xmzj','xmzj@jinbi.com','111111','gc',1,2,NULL,'A'),(49,'xmjl','xmjl@jinbi.com','111111','gc',1,2,NULL,'A'),(50,'xcjl','xcjl@jinbi.com','111111','gc',1,2,NULL,'A'),(51,'zxgz1','zxgz1@jinbi.com','111111','gc',1,2,1000,'A'),(52,'zxgz2','zxgz2@jinbi.com','111111','gc',1,2,2000,'A'),(53,'zxgz3','zxgz3@jinbi.com','111111','gc',1,2,3000,'A'),(54,'aqy1','aqy1@jinbi.com','111111','gc',1,2,100,'A'),(55,'aqy2','aqy2@jinbi.com','111111','gc',1,2,NULL,'A'),(56,'aqy3','aqy3@jinbi.com','111111','gc',1,2,NULL,'A'),(57,'kf1','kf1@jinbi.com','111111','gc',1,2,NULL,'A'),(58,'kf2','kf2@jinbi.com','111111','gc',1,2,NULL,'A'),(59,'gczl','gczl@jinbi.com','111111','gc',1,2,NULL,'A'),(60,'jdfzr','jdfzr@jinbi.com','111111','jd',1,2,NULL,'A'),(61,'kt1','kt1@jinbi.com','111111','jd',1,2,NULL,'A'),(62,'kt2','kt2@jinbi.com','111111','jd',1,2,NULL,'A'),(63,'kt3','kt3@jinbi.com','111111','jd',1,2,NULL,'A'),(64,'dq1','dq1@jinbi.com','111111','jd',1,2,NULL,'A'),(65,'dq2','dq2@jinbi.com','111111','jd',1,2,NULL,'A'),(66,'dq3','dq3@jinbi.com','111111','jd',1,2,NULL,'A'),(67,'jdgz1','jdgz1@jinbi.com','111111','jd',1,2,NULL,'A'),(68,'jdgz2','jdgz2@jinbi.com','111111','jd',1,2,NULL,'A'),(69,'jdgz3','jdgz3@jinbi.com','111111','jd',1,2,NULL,'A'),(70,'cgr1','cgr1@jinbi.com','111111','cg',1,2,NULL,'A'),(71,'cgr2','cgr2@jinbi.com','111111','cg',1,2,NULL,'A'),(72,'hr','hr@jinbi.com','111111','hr',3,2,NULL,'A'),(73,'ht','ht@jinbi.com','111111','ht',1,2,NULL,'A'),(74,'dxk','dxk@jinbi.com','111111','gc',1,2,200,'A'),(75,'gl','gl@jinbi.com','111111','gl',1,2,NULL,'A'),(76,'adminSh','adminSh@jinbi.com','111111','sc',2,2,NULL,'B'),(77,'sc','sc@jinbi.com','111111','sc',1,2,NULL,'B'),(78,'cg','cg@jinbi.com','111111','cg',1,2,NULL,'B'),(79,'qcg','qcg@126.com','111111','hr',1,3,NULL,'B'),(80,'hr','hr@jinbi.com','111111','hr',1,2,NULL,'B'),(81,'gl','gl@jinbi.com','111111','gl',1,2,NULL,'B');
...
insert  into `jb_zjl_fkyj`(`id`,`pro_id`,`fk_bs`,`fk_fb_rate_gc`,`fk_cl_rate_cg`,`fk_time`) values (30,'pro_1','40',3,4,'2014-06-05 00:00:00'),(31,'pro_1','7',2,3,'2014-06-14 00:00:00'),(32,'pro_1','6',1,4,'2014-06-11 00:00:00'),(33,'pro_1','20',0,15,'2014-04-09 00:00:00'),(35,'pro_1','3',0,20,'2014-05-01 00:00:00'),(36,'pro_1','5',0,10,'2014-03-05 00:00:00');
...
CREATE TABLE `jb_zjl_sksj` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=35 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='资金流管理 收款实计表';

/*Data for the table `jb_zjl_sksj` */

insert  into `jb_zjl_sksj`(`id`,`pro_id`,`sk_bs`,`sk_je`,`sk_time`) values (30,'pro_1','4',200,'2014-04-10 00:00:00'),(33,'pro_1','2',100,'2014-03-12 00:00:00'),(32,'pro_1','6',150,'2014-06-17 00:00:00'),(34,'pro_1','5',50,'2014-05-15 00:00:00');
...
insert  into `jb_zjl_skyj`(`id`,`pro_id`,`sk_bs`,`sk_rate`,`sk_time`) values (30,'pro_1','1',0.15,'2014-06-18 00:00:00'),(31,'pro_1','40',0.15,'2014-05-15 00:00:00'),(32,'pro_2','4',5,'2014-06-18 00:00:00'),(33,'pro_1','5',0.05,'2014-04-17 00:00:00'),(34,'pro_1','30',0.1,'2014-03-20 00:00:00');
