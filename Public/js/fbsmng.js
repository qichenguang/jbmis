$(document).ready(function(){
    ...
    function setFbsmngCommJqGrid(domTableId,domPageId,cur_user_id){
        ...
        var colNames = ['ID','分包商名称','联系人电话','邮箱地址','状态'];
        ...
        var $fbscommgridobj = jQuery(domTableId).jqGrid({
            ...
            colModel:[
                ...
                {name:'phone',index:'phone',
                    ...
                    editable:true, edittype:"text",editrules:{required:true},
                    editoptions:{size:"30"},
                    formoptions:{rowpos:3, label: "联系人电话", elmprefix:"(*)"}
                },
                {name:'email',index:'email',
                    ...
                    formoptions:{ rowpos:4,label: "邮箱地址",elmprefix:"(*)"}
                },
                {name:'status',index:'status',
                    ...
                    formoptions:{ rowpos:5,label: "状态",elmprefix:"(*)"}
                }
            ],
            hiddengrid: false,
            autowidth: true,
